...
test('auth flow - login attempt then register', async ({ page }) => {
  await page.goto('/');
  ...
  console.log('Attempting login with random credentials...');
  ...
  console.log('Login failed as expected, switching to registration...');
